...
import com.learnwebclienmocking.enums.Role;
...
import static com.learnwebclienmocking.service.EmployeeService.ADD_EMPLOYEE;
import static com.learnwebclienmocking.service.EmployeeService.PATH_PARAM_BY_ID;
...
public class EmployeeServiceTest {
    ...
    void getEmployeeById(){
        ...
        when(requestHeadersUriSpec.uri(PATH_PARAM_BY_ID, employeeId)).thenReturn(requestHeadersSpec);
    ...
    void addNewEmployee(){
        ...
        when(requestBodyUriSpec.uri(ADD_EMPLOYEE)).thenReturn(requestBodySpec);
    ...
    void updateEmployee(){
        ...
        when(requestBodyUriSpec.uri(PATH_PARAM_BY_ID,employeeId)).thenReturn(requestBodySpec);
